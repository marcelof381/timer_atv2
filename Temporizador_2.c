...
int64_t turn_off_callback(alarm_id_t id, void *user_data) {
    switch (step) {
        case 0:
            ...
            add_alarm_in_ms(3000, turn_off_callback, NULL, false); // Agenda próxima execução
            break;
        ...
        case 2:
            ...
            step = 0; // Reinicia o contador de passos
            last_led_state = 0; // Atualiza o estado do LED
            return 0; // Finaliza a cadeia de callbacks

        default:
            break; // Caso step tenha um valor inesperado
    }

    step++; // Incrementa o passo para a próxima execução
